...
import { ReportEngine } from '@/components/modules/water-tax/reports/ReportEngine';
import { CollectionReport } from '@/components/modules/water-tax/reports/CollectionReport';
import { CRMReport } from '@/components/modules/water-tax/reports/CRMReport';
import { QuickReports } from '@/components/modules/water-tax/reports/QuickReports';
import { AutoReportNotification } from '@/components/modules/water-tax/reports/AutoReportNotification';

// Water Tax Module - AI
import { DataEngine } from '@/components/modules/water-tax/ai/DataEngine';
import { SearchBar } from '@/components/modules/water-tax/ai/SearchBar';
import { SearchResultsGrid } from '@/components/modules/water-tax/ai/SearchResultsGrid';

// Water Tax Module - SMS
import { SMSManager } from '@/components/modules/water-tax/sms/SMSManager';

// Water Tax Module - Tables
import { ReportResultsTable } from '@/components/modules/water-tax/tables/ReportResultsTable';
import { TopDefaultersTable } from '@/components/modules/water-tax/tables/TopDefaultersTable';
import { PendingReadingTable } from '@/components/modules/water-tax/tables/PendingReadingTable';
import { ClosedConnectionTable } from '@/components/modules/water-tax/tables/ClosedConnectionTable';

// Water Tax Module - Filters
import { FilterPanel } from '@/components/modules/water-tax/filters/FilterPanel';
import { CollectionReportFilter } from '@/components/modules/water-tax/filters/CollectionReportFilter';
import { AccountantFilter } from '@/components/modules/water-tax/filters/AccountantFilter';
import { MutationReportFilter } from '@/components/modules/water-tax/filters/MutationReportFilter';
import { AlterationReportFilter } from '@/components/modules/water-tax/filters/AlterationReportFilter';
import { CollectionDetailsFilter } from '@/components/modules/water-tax/filters/CollectionDetailsFilter';

// Water Tax Module - Modals
import { ConfirmDialog } from '@/components/modules/water-tax/modals/ConfirmDialog';
import { ExportToExcelDialog } from '@/components/modules/water-tax/modals/ExportToExcelDialog';
import { DownloadLogModal } from '@/components/modules/water-tax/modals/DownloadLogModal';
import { LastWorkSummaryPopup } from '@/components/modules/water-tax/modals/LastWorkSummaryPopup';
...
import { 
  ...
  detectDailyPattern, 
  wasGeneratedToday 
} from '@/lib/utils/reportTracking';

// Types
import type { Language, MainTab, EngineTab, SubTab, AutoReportNotification as AutoReportNotificationType } from '@/types/common.types';

export default function HomePage() {
  const [activeMainTab, setActiveMainTab] = useState<MainTab>('reports');
  const [activeEngineTab, setActiveEngineTab] = useState<EngineTab>('reports');
  const [activeSubTab, setActiveSubTab] = useState<SubTab>('engine');
  ...
  const [autoReportNotification, setAutoReportNotification] = useState<AutoReportNotificationType>({
    isOpen: false,
    reportName: '',
    reportType: '',
  });
