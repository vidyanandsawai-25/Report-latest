import { AutoReportNotification } from './components/AutoReportNotification';
import { ReportResultsTable } from './components/ReportResultsTable';
import { TopDefaultersTable } from './components/TopDefaultersTable';
import { PendingReadingTable } from './components/PendingReadingTable';
import { ClosedConnectionTable } from './components/ClosedConnectionTable';
import { DownloadLogModal } from './components/DownloadLogModal';
import { useState, useEffect } from 'react';
import { Sidebar } from './components/Sidebar';
import { Header } from './components/Header';
import { SearchBar } from './components/SearchBar';
import { EngineTabNavigation } from './components/EngineTabNavigation';
...
import { CollectionReportFilter } from './components/CollectionReportFilter';
import { ReadingSummaryFilter } from './components/ReadingSummaryFilter';
import { ConnectionSealFilter } from './components/ConnectionSealFilter';
import { PaymentModeFilter } from './components/PaymentModeFilter';
import { RevenueSummaryFilter } from './components/RevenueSummaryFilter';
import { AccountantFilter } from './components/AccountantFilter';
import { MutationReportFilter } from './components/MutationReportFilter';
import { AlterationReportFilter } from './components/AlterationReportFilter';
import { CollectionDetailsFilter } from './components/CollectionDetailsFilter';
import { ConfirmDialog } from './components/ConfirmDialog';
import { ExportToExcelDialog } from './components/ExportToExcelDialog';
import { SearchResultsGrid } from './components/SearchResultsGrid';
import { LastWorkSummaryPopup } from './components/LastWorkSummaryPopup';
...
import waterDropletBg from 'figma:asset/32de86388d824fe7968a4cc79a8ad3203d01778a.png';
    ...
    <div className="min-h-screen bg-[#F5F5F5] relative overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        <img
          ...
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] object-contain opacity-[0.02] blur-[0.5px]"
        />
      </div>
      ...
      <button
        ...
        className="md:hidden fixed top-4 left-4 z-50 w-10 h-10 bg-[#1976D2] text-white rounded-lg flex items-center justify-center shadow-lg hover:shadow-xl transition-all hover:bg-[#1565C0]"
      >
