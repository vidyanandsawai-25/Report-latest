...
import { X, AlertTriangle, User, RefreshCcw, MapPin, Layers, FileText, Calendar, Download } from 'lucide-react';
...
interface MutationReportFilterProps {
  isOpen: boolean;
  onClose: () => void;
  onSearch: () => void;
  onExport: () => void;
...
export function MutationReportFilter({ isOpen, onClose, onSearch, onExport }: MutationReportFilterProps) {
  ...
  const mutationTypes = [
    {
      id: 'name-change',
      title: 'Name Change',
      description: 'Update consumer name details',
      icon: User,
      color: '#3B82F6',
    ...
    },
    {
      ...
      description: 'Transfer water connection ownership',
      icon: RefreshCcw,
      color: '#8B5CF6',
    ...
    },
    {
      ...
      description: 'Modify connection category',
      icon: Layers,
      color: '#F97316',
    ...
    {
      id: 'all-reports',
      title: 'All Ferfar Reports',
      description: 'View all modification reports',
      icon: FileText,
      color: '#6366F1',
      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 bg-gradient-to-br from-black/60 via-orange-900/20 to-black/60 backdrop-blur-md z-40"
          >
            {/* Animated particles */}
            {[...Array(6)].map((_, i) => (
              <motion.div
          ...
          <motion.div
            ...
            className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[95vw] max-w-5xl max-h-[90vh] bg-white rounded-3xl shadow-2xl z-50 overflow-hidden border-4 border-orange-500/20"
          >
            {/* Header */}
            <div className="bg-gradient-to-r from-[#D97706] to-[#F59E0B] p-6 pb-5 relative overflow-hidden">
              ...
              <div className="flex items-center justify-between relative z-10">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/90 text-sm mt-0.5">Select modification type and date range</p>
                  </div>
                </div>
            ...
            <div className="p-5 overflow-y-auto max-h-[calc(90vh-200px)]">
              ...
              <div className="mb-5">
                <Label className="mb-3 block text-gray-900">Select Modification Type *</Label>
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3">
                  {mutationTypes.map((type, index) => (
                    <motion.button
                      key={type.id}
              ...
              <div className="grid md:grid-cols-2 gap-4 bg-gradient-to-br from-blue-50 to-cyan-50 p-4 rounded-2xl border-2 border-blue-100 mb-5">
                <motion.div
                ...
                >
                  ...
                  <div className="relative">
                    <input 
                      ...
                      className="w-full h-10 px-3 py-2 border-2 border-gray-200 rounded-xl outline-none focus:ring-2 focus:ring-[#D97706] focus:border-[#D97706] cursor-pointer bg-white text-gray-800 transition-all text-sm"
                    />
            ...
            <div className="border-t-2 border-gray-100 bg-gradient-to-r from-orange-50/50 to-amber-50/50 p-5">
